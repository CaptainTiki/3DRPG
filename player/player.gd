...
func handle_slashing_physics_frame(delta: float) -> void:
	...
	attack_raycast.deal_damage(user_interface.inventory.get_weapon_value() + stats.get_damage_modifier(), stats.get_crit_chance())
...
func _on_rig_heavy_attack() -> void:
	area_attack.deal_damage(user_interface.inventory.get_weapon_value() + stats.get_damage_modifier(), stats.get_crit_chance())
